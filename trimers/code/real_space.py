...
def get_elfs(atoms, density, basis, view = serial_view(), orient_mode = 'none'):
    ...
    ----------
        ...
        orient_mode: str
            ...
            'power_spectrum': take the power spectrum of complex tensor
    ...
    basis_species = np.unique([b.split('_')[-1] for b in basis]) 
    density_list = []
    pos_list = []
    sym_list = []
    basis_list = []
...
def orient_elf(i, elf, all_pos, mode):
    ...
    Parameters
        ...
        mode: str
            ...
            'nn': use the nearest neighbour algorithm
            'casimir': take Casimir norm of complex tensor
            'power_spectrum' use the power spectrum
            'neutral': keep alignment unchanged}
