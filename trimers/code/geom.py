...
#         """
                        ...
                        for m1 in range(-l1, l1+1):
                            for m2 in range(-l2,l2+1):
                                     b += np.conj(c[:,n,start[l] + m + l])*\
                                        c[:,n,start[l1] + m1 + l1]*\
                                        c[:,n,start[l2] + m2 + l2]*\
                                        cgs[l1,l2,l,m1,m2,m] # Modified the position of the coefficients
                                        #cgs[l1,m1,l2,m2,l,m] # ORIGINAL
    ...
    #bispectrum = np.dot(casimirs, bispectrum)
    return bispectrum
